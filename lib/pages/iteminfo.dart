...
Map<String, List<Item>> categorizedItems = {
  'Tools': [
    ...
    Item(
      ...
      price: ' ₹1,599',
      imageAsset: 'assets/images/products/Tool9.png',
    ),
    Item(
      info: 'MLA TOOLS Earth Auger Digger Drill Bit 6, 4,3, inch Daimter ',
      price: '₹1,099',
      imageAsset: 'assets/images/products/Tool10.png',
    ),
